...
void kOmegaWilcox2006ReTB<BasicTurbulenceModel>::correctNut
(
...
template<class BasicTurbulenceModel>
void kOmegaWilcox2006ReTB<BasicTurbulenceModel>::correctB()
{
...
template<class BasicTurbulenceModel>
kOmegaWilcox2006ReTB<BasicTurbulenceModel>::kOmegaWilcox2006ReTB
(
...
template<class BasicTurbulenceModel>
bool kOmegaWilcox2006ReTB<BasicTurbulenceModel>::read()
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField> kOmegaWilcox2006ReTB<BasicTurbulenceModel>::omegaTilde1
(
    const volScalarField& S2
)
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField> kOmegaWilcox2006ReTB<BasicTurbulenceModel>::omegaTilde2()
{
...
template<class BasicTurbulenceModel>
void kOmegaWilcox2006ReTB<BasicTurbulenceModel>::correct()
{
